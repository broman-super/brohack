--// SeHub - Session Time Edition (Updated: Added Infinite Jump)
--// Features: Themes, Players, Waypoints (+Binds), Keybinds, Array List, Air Walk, TP Fling, FE INVIS, ADVANCED ESP, Scroll Fly, Infinite Jump
--// Keybind: J
...
createSwitch(pCombat, "Infinite Jump", function(v) infJumpEnabled = v end) -- New Fitur
...
print("SeHub V2 Loaded Successfully")
